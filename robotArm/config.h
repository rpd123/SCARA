...
//SCARA SETTINGS
#define SCARA true
#define L1 140.0  // shank length
#define L2 (100.0 + 45.0)  // shank length + gripperoffset
#define LEAD 8.0
...
#define INVERSE_Y_STEPPER false // CHANGE IF STEPPER MOVES OTHER WAY. My cartesian robot does!
